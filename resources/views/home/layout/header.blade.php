			...
			<div class="contact-info">
				...
				<div class="box-icon-1">
					...
					<div class="body-content">
						...
						info@africafactorymartintl.com
					</div>
				</div>
				<!-- INFO 2 -->
				<div class="box-icon-1">
				...
				<!-- INFO 3 -->
				<a href="/quote" title="" class="btn btn-cta pull-right">GET A QUOTE</a>
				...
				<nav class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="dropdown">
							...
							<li><a href="/about#clients">OUR PARTNERS</a></li>
							</ul>
						</li>
						<li class="dropdown">
						...
						<li class="dropdown">
							<a href="/projects" aria-expanded="false">PROJECTS </a>
						</li>
						<li class="dropdown">
